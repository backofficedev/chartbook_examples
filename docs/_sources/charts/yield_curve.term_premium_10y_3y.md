...
# Chart: Term Premium (10Y-3Y)
10-year minus 3-year Treasury yield spread over time

## Chart
```{raw} html
<iframe src="../_static/yield_curve/term_premium_10y_3y.html" height="500px" width="100%"></iframe>

<p style="text-align: center;">Sources: Federal Reserve Board</p>
```
[Full Screen Chart](../download_chart/yield_curve/term_premium_10y_3y.html)
...
| Chart Name             | Term Premium (10Y-3Y)                                             |
|------------------------|------------------------------------------------------------|
| Chart ID               | term_premium_10y_3y                                               |
...
| HTML Chart             | [HTML](../download_chart/yield_curve/term_premium_10y_3y.html)    |
...
| Dataframe Path                 | /Users/jbejarano/GitRepositories/backofficedev/chartbook_examples/yield_curve/_data/term_premium.parquet                                                   |
