...
# Chart: Term Premium (10Y-2Y)
10-year minus 2-year Treasury yield spread over time

## Chart
```{raw} html
<iframe src="../_static/yield_curve/term_premium_10y_2y.html" height="500px" width="100%"></iframe>

<p style="text-align: center;">Sources: Federal Reserve Board</p>
```
[Full Screen Chart](../download_chart/yield_curve/term_premium_10y_2y.html)
...
| Chart Name             | Term Premium (10Y-2Y)                                             |
|------------------------|------------------------------------------------------------|
| Chart ID               | term_premium_10y_2y                                               |
...
| HTML Chart             | [HTML](../download_chart/yield_curve/term_premium_10y_2y.html)    |
